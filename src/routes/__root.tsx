  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <h2 className="mt-4 text-xl font-semibold text-foreground">Surface not found</h2>
        <p className="mt-2 text-sm text-muted-foreground">
          This part of Nexus doesn't exist yet, or it has moved.
        </p>
        <div className="mt-6">
          <Link
            to="/"
  ...
  head: () => ({
    meta: [
      ...
      { title: "Nexus — AI Operating System" },
      {
        name: "description",
        content:
          "Nexus is a premium AI operating system for your work: assistant, workspaces, tasks, knowledge and automations in one calm interface.",
      },
